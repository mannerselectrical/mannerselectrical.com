...
document.querySelectorAll('nav a,a[href="#contact"]').forEach(function (node) {
...
window.setInterval(function () {
    ...
    var sections = ["services", "area", "aboutme", "contact", "testimonials"];
    ...
    if (most[0]) {
        //console.log("here!", most);
        document
            .querySelector("a[href='#" + most[1] + "']")
